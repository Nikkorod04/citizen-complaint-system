                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" id="national_id" name="national_id" value="{{ old('national_id', $user->national_id) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-600 focus:ring-1 focus:ring-blue-500 @error('national_id') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="emergency_contact_name" name="emergency_contact_name" value="{{ old('emergency_contact_name', $user->emergency_contact_name) }}" required @input="filterAlphabeticOnly($event)" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-600 focus:ring-1 focus:ring-blue-500 @error('emergency_contact_name') border-red-500 @enderror" />
                                ...
                                <div>
                                    ...
                                    <input type="text" id="emergency_contact_number" name="emergency_contact_number" value="{{ old('emergency_contact_number', $user->emergency_contact_number) }}" required maxlength="11" @input="formatPhoneNumber($event)" placeholder="09XXXXXXXXX" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-600 focus:ring-1 focus:ring-blue-500 @error('emergency_contact_number') border-red-500 @enderror" />
