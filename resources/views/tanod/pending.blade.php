                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-yellow-500">
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">
                                            Submitted by: <span class="font-semibold">{{ $request->citizen->full_name }}</span>
                                        </p>
                                    </div>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <form method="POST" action="{{ route('tanod.assign', $request->id) }}" style="display: inline;">
                                        @csrf
            ...
            @else
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        <p class="mt-4 text-gray-600 text-lg">No pending requests at the moment.</p>
                    </div>
                </div>
            @endif
