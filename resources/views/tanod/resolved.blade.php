                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-green-500">
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 pb-4 border-b border-gray-200">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-600 font-medium">Resolved</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $request->resolved_at->format('M d, H:i') }}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-600 font-medium">Time to Resolve</p>
                                        <p class="text-sm font-semibold text-gray-900">
                                            {{ $request->resolved_at->diffForHumans($request->submitted_at, ['parts' => 2]) }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <a href="{{ route('tanod.show', $request->id) }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition inline-block">
                                    View Full Details
                                </a>
                            </div>
                        </div>
            ...
            @else
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        <p class="mt-4 text-gray-600 text-lg">No resolved requests yet.</p>
                    </div>
                </div>
            @endif
